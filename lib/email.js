...
// Shared copy for the learner/trainer "forgot password" flow — dashboard
// name is the only thing that differs between the two callers.
export function passwordResetEmail({ name, resetUrl, dashboardName }) {
  return {
    subject: `Reset your ${dashboardName} password`,
    html: `
      <p>Hi ${name},</p>
      <p>We received a request to reset the password for your ${dashboardName} on Vidyam Learning Month. If this was you, choose a new password here:</p>
